...
function Footer() {
  return (
    ...
    //   <Box
    //     sx={{
    //       backgroundColor: grey[900], color: "white", width: 1  
    //     }}
    //     // px={{ xs: 0, sm: 0 }}
    //     // py={{ xs: 0, sm: 0 }}
    //     component="footer"
    ...
    //         <Grid container spacing={2} style={{ lineHeight: 1.5 }}>
    //           <Grid item xs={12} sm={4}  >
    //             <Box borderBottom={1}>Help</Box>
    //             <Box>
    //               <Link to={"/"} color="inherit" style={{ textDecoration: 'none' }}>Contact</Link>
    //             </Box>
    //             <Box>
    //               <Link to={"/"} color="inherit" style={{ textDecoration: 'none' }}>Support</Link>
    //             </Box>
    //             <Box>
    //               <Link to={"/"} color="inherit" style={{ textDecoration: 'none' }}>Privacy</Link>
    //             </Box>
    //           </Grid>
    //           <Grid item xs={12} sm={4}  >
    //             <Box borderBottom={1}>Help</Box>
    ...
    //           </Grid>
    //         </Grid>
    //         <Box textAlign="center" pt={{ xs: 5, sm: 3 }} pd={{ xs: 5, sm: 0 }}>
    //           Phung Tran Thanh Nam love Ngoc Han &reg; {new Date().getFullYear()}
    //         </Box>
    //       </Typography>
